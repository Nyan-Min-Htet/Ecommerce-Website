...
<head>
    ...
    <title>Fruits Trees & Brushes</title>
        ...
        <div class="row">
            <div class="col">
                <div class="section-heading">
                    <h2>FRUITS TREES & BRUSHES PRODUCTS</h2>
                    <span>CHECK OUT ALL OF FRUITS TREES & BRUSHES PRODUCTS.</span>
                </div>
            </div>
        </div>
    </div>
